		...
		<nav class="navbar navbar-expand-lg navbar-light bg-white ">
				...
				<div class="collapse navbar-collapse justify-content-end gauche" id="navbarSupportedContent">
				 <div class="">
					<ul class="navbar-nav">
						<li class="nav-item ">
						  <a class="nav-link ecart1 font-weight-bold text-danger" href="../simplon/pages/enregister.php">ENREGISTRER UN APPRENANT</a>
						</li>
						<li class="nav-item">
							<a class="nav-link ecart2 font-weight-bold text-danger" href="../simplon/pages/liste_apprenants.php">LISTE</a>
						  </li>
					  </ul>
				 </div>
